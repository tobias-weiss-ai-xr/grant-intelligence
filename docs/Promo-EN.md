...
> **80 programmes, 9 funding categories, open source (MIT), local &
...
> source, covers 80 programmes across nine funding categories, and connects
...
> - 📊 **Facts over hype** — 80 programmes, 9 categories, 100 % test coverage
>
...
>
> Open source (MIT) · MCP-based · 80 programmes · first pilot at the
...
| 1:45–2:00 | State catalog number | "80 programmes across nine categories — DFG, ERC, national, regional, foundations, EU, industry, international. All from official sources, every deadline with an 'as of' date." |
